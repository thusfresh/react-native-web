...
ScrollViewBase=function(_Component){_inherits(ScrollViewBase,_Component);function ScrollViewBase(){var _ref;var _temp,_this,_ret;_classCallCheck(this,ScrollViewBase);for(var _len=arguments.length,args=Array(_len),_key=0;_key<_len;_key++){args[_key]=arguments[_key];}return _ret=(_temp=(_this=_possibleConstructorReturn(this,(_ref=ScrollViewBase.__proto__||Object.getPrototypeOf(ScrollViewBase)).call.apply(_ref,[this].concat(args))),_this),_this.
...
_debouncedOnScrollEnd=(0,_debounce2.default)(_this._handleScrollEnd,100),_this.
_state={isScrolling:false,scrollLastTick:0},_this.
...
},_temp),_possibleConstructorReturn(_this,_ret);}_createClass(ScrollViewBase,[{key:'_handleScrollStart',value:function _handleScrollStart(
